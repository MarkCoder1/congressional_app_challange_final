    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-card rounded-xl border border-border p-4 shadow-sm">
          ...
          <p className="text-2xl font-bold text-foreground">{analytics.streak} days</p>
        </div>
      </div>
      ...
      <div className="bg-card rounded-xl border border-border p-4 shadow-sm">
        ...
        <div className="space-y-2">
          {analytics.subjectDistribution.map((item: { subject: string; hours: number }) => (
      ...
      <div className="bg-card rounded-xl border border-border p-4 shadow-sm">
        ...
        <div className="flex items-end gap-2 h-24">
          {analytics.productivityTrend.map((val: number, idx: number) => (
            <div
              key={idx}
